...
test_data = [
    (24 * 3600, 22 * 3600, 60, np.array([4.1, 42., 46.5, 44.8, 52.2]), np.array([130, 49, 32, 38, 11])),
    (2 * 3600,   8 * 3600, 60, np.array([41., 42., 43., 44., 45.]),    np.array([17,  15, 11,  7,  4])),
    (10 * 3600,  6 * 3600, 300, np.array([54., 55., 55., 55., 55.]),   np.array([1,    0,  0,  0,  0]))
]
